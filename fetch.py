#!/usr/bin/env python3
"""
Recuperation des codes promo Hardloop depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/hardloop.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/hardloop.fr"
STORE_NAME = "Hardloop"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Hardloop depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-hardloop)"
    }
    try:
